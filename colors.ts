...
export function getColorPalettes(
  ...
  if (neutralColor) {
    ...
    neutralPalette = TonalPalette.fromHueAndChroma(primaryColorHct.hue, primaryColorHct.chroma / 8.0);
  }

  const neutralVariantPalette = TonalPalette.fromHueAndChroma(primaryColorHct.hue, primaryColorHct.chroma / 8.0 + 4.0);
 ...
 */
export function getHighContrastOverridesCSS(lightColorScheme: DynamicScheme, darkColorScheme: DynamicScheme): string {
  let css = "\n";
 ...
 */
function getColorComment(primaryColor: string, secondaryColor?: string, tertiaryColor?: string, neutralColor?: string) {
...
export default function wow(options) {
